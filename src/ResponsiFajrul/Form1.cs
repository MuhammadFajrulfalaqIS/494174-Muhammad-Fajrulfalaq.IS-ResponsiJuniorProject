...
namespace ResponsiFajrul
{
    ...
    {
        string connString = "Host=localhost;Port=5432;Username=postgres;Password=informatika;Database=ResponsiFajrul";
        string sql;
        NpgsqlCommand cmd;
        public DataTable dt;
        ...
        private void LoadData()
        {
            ...
            try
            {
                ...
                sql = @"SELECT k.id_kar, k.nama_kar, k.id_dept, d.nama_dept FROM karyawan k JOIN departemen d ON k.id_dept = d.id_dept";
